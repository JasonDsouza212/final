...
import { adminUpdate, adminLogout} from '../../redux/action/adminAction'
...
const AdminUpdateProfile = () => {
    ...
    const [adminMobileNumber, setContactNumber] = useState('')
    ...
    const formHandler = async (e) => {
        ...
        formData.append("adminMobileNumber", adminMobileNumber)
        formData.append("aadharCard", aadharCard)
        formData.append("avatar", avatar)
        formData.append("email", store.admin.admin.email)
        setIsLoading(true)
        dispatch(adminUpdate(formData, history))
    ...
    useEffect(() => {
        if (store.admin.updateProfileFlag) {
            setIsLoading(false)
        }
    }, [store.admin.updateProfileFlag])
    return (
        <div>
