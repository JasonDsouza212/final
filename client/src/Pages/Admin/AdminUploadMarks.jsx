    ...
    return (
        <div>
            {store.admin.isAuthenticated ? <>
                <AdminHomeHelper />
                {store.admin.fetchedStudentsHelper && <div className="row justify-content-center mt-4 ">
                        ...
                        <form onSubmit={secondFormHandler}>
                            <div className="form-group">
                                ...
                                <select onChange={(e) => setSubjectCode(e.target.value)} className={classnames("form-control",
                                    ...
                                    <option>Select</option>
                                    {
                                        store.admin.allSubjectCodeList.map(subjectCodeName =>
                            ...
                            <div className="form-group">
                                ...
                                <select onChange={(e) => setExam(e.target.value)} value={exam} className={classnames("form-control",
                                    ...
                                    <option>Select</option>
                                    <option value="CycleTest1">INTERNAL ASSESSMENT 1</option>
                                    <option value="CycleTest2">EVENT 1</option>   
                                    <option value="CycleTest3">INTERNAL ASSESSMENT 2</option>   
                                    <option value="CycleTest4">EVENT 2</option>   
                                    <option value="CycleTest5">INTERNAL ASSESSMENT 3</option>   
                            ...
                            <table className="table">
                                ...
                                <tbody>
                                    {
                                        store.admin.fetchedStudents.map((obj, index) =>
                                            <tr key={index}>
