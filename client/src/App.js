...
import AdminUploadMarks from './Pages/Admin/AdminUploadMarks'
    ...
    <div>
      <Router>
        <Switch>
          ...
          <Route exact path="/admin/updateProfile" component={AdminUpdateProfile} />

          <Route exact path="/admin/uploadMarks" component={AdminUploadMarks} />
